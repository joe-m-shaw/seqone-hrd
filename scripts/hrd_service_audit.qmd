...
source(here("scripts/collate_seqone_audit_data.R"))
...
The Myriad "Genomic Instability Score" (GIS) is the sum of counts for LST, TAI and LOH events in the sample. What happens if we sum LPC and LGA events in the same way?
...
Some sWGS HRD solutions only look at LGA events.
